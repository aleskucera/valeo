...
def frame_preprocess(pc1, pc2, gt_flow):
    ...
    # mask1 = np.logical_and(pc1[:, 1] < y_max, pc1[:, 0] < x_max, pc1[:, 2] < z_max, pc1[:, 2] > z_min)
    # mask2 = np.logical_and(pc2[:, 1] < y_max, pc2[:, 0] < x_max, pc2[:, 2] < z_max, pc2[:, 2] > z_min)
